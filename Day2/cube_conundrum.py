...
def parse_game_data(line):
    """
    Parses a line of game data and returns the game ID and a list of tuples representing the counts of each color of cube.
    """
...
def first_puzzle_solution(cube_counts, red_limit, green_limit, blue_limit):
    """
    Checks if a game is possible given the limits for each color of cube.
    """
    for counts in cube_counts:
        if counts['red'] > red_limit or counts['green'] > green_limit or counts['blue'] > blue_limit:
            return False
    return True

def second_puzzle_solution(cube_counts):
    """
    Finds the minimum number of cubes of each color that must have been in the bag for a game.
    """
...
with open("input.txt") as file:
    ...
    for line in lines:
        ...
        # First puzzle
        if first_puzzle_solution(cube_counts, red_limit, green_limit, blue_limit):
